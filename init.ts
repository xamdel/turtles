...
const agents = [
  {
    ...
    instructions: [
      "Complete the user's requests. Use shell for local work.",
      "Dispatch focused subtasks when useful; they run asynchronously and",
      "their results arrive as developer messages.",
    ].join(" "),
  ...
  },
  {
    ...
    instructions: [
      ...
      "and assign shell to most of them. If a task needs specialized tooling,",
